...
//            'text_description_english' => (string)$info->text_description_anglais()
        ...
        foreach ($data->sortBy('year', 'desc') as $oneproject) {
            $json['thesis'][] = array(
                ...
                'description_thesis_french'     => (string)$oneproject->description_thesis_french()->kirbytext(),
                'description_thesis_english'    => (string)$oneproject->description_thesis_english()->kirbytext(),
